...
Un bot de Discord complet scris în Python, care integrează inteligența artificială DeepSeek pentru conversații directe, alături de comenzi utile pentru vreme, utilități de profil și unelte de moderare pentru server.

Tehnologii Folosite

* Limbaj: Python
* Librărie principală: Discord.py
* Integrare AI: DeepSeek API (modelul deepseek-chat)
...
* reset - Resetează memoria discuției cu AI-ul.
